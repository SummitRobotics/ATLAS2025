...
import frc.robot.util.JoystickResponseCurve;
...
public class RobotContainer {
 ...
 private JoystickResponseCurve driveCurve =
    ...
    private JoystickResponseCurve rotationCurve =
       new JoystickResponseCurve(JoystickResponseCurve.CurveType.MILD, rotationDeadband);
    ...
    private void configureBindings() {
        ...
        drivetrain.setDefaultCommand(
            ...
            drivetrain.applyRequest(() -> {
                    double leftY = -joystick.getLeftY(); // Drive forward with negative Y (Joystick UP)
                    double leftX = -joystick.getLeftX(); // Drive left with negative X (Joystick LEFT)
                    double rightX = -joystick.getRightX(); // Drive counterclockwise with negative X (Joystick LEFT)
